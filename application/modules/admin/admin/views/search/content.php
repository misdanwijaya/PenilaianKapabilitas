...
<?php $num_rows = core::get_search('admin','default',$this->input->get('search'),$this->input->get('search_by'))->num_rows();?>
...
<?php foreach(core::get_search_pagination('admin','default',$this->input->get('search'),$this->input->get('search_by'),$per_page,$url)->result() as $row): { ?><tr>
<td><?php echo $i;?></td>
