...
<?php $num_rows = core::get_search('pbk','default',$this->input->get('search'),$this->input->get('search_by'))->num_rows();?>
...
<?php foreach(core::get_search_pagination('pbk','default',$this->input->get('search'),$this->input->get('search_by'),$per_page,$url)->result() as $row): { ?><tr>
  <?php $groups = core::get_where('pbk_groups','default',array('ID' => $row->GroupID));?>
