          ...
          <div class="row top_tiles">
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <?php $jumlah  = core::manualQuery("select count(id) as id from area_proses","default")->result();
                    foreach ($jumlah as $key ) {
                      $jml = $key->id;
                  }
                  ?>
            ...
            <div class="col-md-12">
              <!-- <div class="x_panel"> -->
                ...
                <div class="x_content">
                  ...
                  core::manualQuery("
                  SELECT 
                    ROUND(SUM(total_IKM)*25,2) as IKM, area_proses FROM
                  (
                    SELECT su.area_proses, su.id, r.id_subunit, 
                    ...
                    INNER JOIN area_proses su on su.id = r.id_subunit 
                  ...
                  <div class="col-md-3 col-sm-12 col-xs-12">
                    <div>
                      ...
                      <?php $jumlah  = core::manualQuery("select r.nama_responden, s.area_proses from responden r INNER JOIN area_proses s on s.id = r.id_subunit","default")->result();
                          foreach ($jumlah as $key ) {?>
                        <li class="media event">
                          ...
                          <div class="media-body">
                            ...
                            <p><strong></strong> <?php echo $key->area_proses?>  </p>
