...
# Deskripsi : Mesin untuk memproses fuzzy dari file CSV otomatis tanpa memasukan ID area proses
#################################
import csv
import numpy as np
...
for a in range(11, 35):
    ...
    fuzzy_temp2 = z[0]
    add_upload(b, number1, number2, number3, number4, number5, fuzzy_temp2)
